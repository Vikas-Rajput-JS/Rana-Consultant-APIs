...
const SendMail = await transporter.sendMail({
    from: '" Rana Consultancy', // sender address
    to: email, // list of receivers
    subject: "Welcome to Rana Consultancy", // Subject line
    text: "You may forgot your password in  Rana Consultancy", // plain text body
